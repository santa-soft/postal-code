import { readCSVObjects, ensureFile } from "./deps.ts"
import { PostalAddress } from "./types.ts";

const outputFilePath = "./.local/postal_codes.json";
...
await Deno.writeTextFile(outputFilePath, JSON.stringify(addresses), { append: false });
